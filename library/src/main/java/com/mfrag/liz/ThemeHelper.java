...
public class ThemeHelper {
    ...
    public void updateTheme() {
        this.primaryColor = Hawk.get(context.getString(R.string.preference_primary_color), getColor(R.color.md_indigo_500));
        this.accentColor = Hawk.get(context.getString(R.string.preference_accent_color), getColor(R.color.md_light_blue_500));
    ...
    public static int getPrimaryColor(Context context) {
        return Hawk.get(context.getString(R.string.preference_primary_color), ContextCompat.getColor(context, R.color.md_indigo_500));
    }
    ...
    public static int getAccentColor(Context context) {
        return Hawk.get(context.getString(R.string.preference_accent_color), ContextCompat.getColor(context, R.color.md_light_blue_500));
    }
    ...
    public void setSwitchCompactColor(SwitchCompat sw, int color){
        ...
        sw.getTrackDrawable().setColorFilter(
                sw.isChecked() ? ColorPalette.getTransparentColor(color, 100): (baseTheme.equals(Theme.LIGHT) ? getColor(R.color.md_grey_400) : getColor(R.color.md_grey_900)),
                PorterDuff.Mode.MULTIPLY);
    }
